...
import arrow from "../assets/img/Png/box_Weiter(Arrow).png";
import Arrow_btn_nav from "../assets/img/webp/line_nav_img.webp";

const Weiter = () => {
  return (
    <>
      <section className="Weiter py-lg-5 py-4">
        <div className=" container">
          <div className="d-flex justify-content-center align-items-center w-100 flex-column">
            <h3 className=" text_theme_white line_before position-relative text-center d-inline-block ff_Montserrat fw-normal fs_sm ">
              Die nächsten Schritte
            </h3>
            <h2 className=" ff_Poiret fs_xl fw-normal text_strock1_themeWhite text_theme_white text-sm-start text-center">
                ...
                <div className="col-lg-3 col-md-6 position-relative">
                  <div className="d-flex align-items-center flex-column text_theme_white justify-content-center mt-xl-5 pb-xl-4 pt-3 px-3 box_Weiter h-100 position-relative">
                    ...
                    <p className="text-center">
                      Vereinbare online deinen Termin und beantworte einige
                      Fragen, damit wir uns optimal auf dich vorbereiten können.
                    </p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-6 position-relative">
            ...
            <div className="mt-xl-4 mt-3 pt-lg-3">
